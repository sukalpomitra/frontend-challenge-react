...
var InstaTypeComponent = React.createClass({displayName: "InstaTypeComponent",
  ...
  render: function(){
    return (
      React.createElement("div", {id: "instatype", onTouchStart: this.handleTouch}, 
        ...
        React.createElement("div", {className: "input-wrapper"}, 
          React.createElement(InputComponent, {
            ...
            ref: "inputComponent"}), 
             ...
             this.state.loading &&
              React.createElement(LoadingComponent, {icon: this.props.loadingIcon})
...
},{"./../css/style.css":3,"./components/input.js":5,"./components/loading.js":6,"./components/results.js":8,"react":157}],5:[function(require,module,exports){
var React = require('react');
...
var LoadingComponent = React.createClass({displayName: "LoadingComponent",
    ...
    render: function(){
      return (
          React.createElement("img", {className: "loading-icon", src: this.props.icon})
      );
    }
});
...
var Result = React.createClass({displayName: "Result",
  ...
  render: function(){
    ...
    return (
      React.createElement("li", {className: className, onClick: this.handleSelect, onMouseOver: this.onMouseOver, onMouseLeave: this.onMouseLeave}, 
          this.props.image && 
...
var ResultsComponent = React.createClass({displayName: "ResultsComponent",
  ...
  render: function(){
    ...
    var resultNodes = this.props.data.map(function(result){
      return (
        React.createElement(Result, {image: result.image, handleSelect: this.props.handleSelect, data: result, key: result.id}, 
            result.name
        )
      );
    }.bind(this));
    ...
    return (
      React.createElement("div", {className: "resultsContainer"}, 

         this.props.data.length > 0 &&
          React.createElement("ul", {className: resultsClass}, 
              resultNodes
          )
...
},{"./result.js":7,"react":157}],9:[function(require,module,exports){
//! moment.js
//! version : 2.10.6
...
},{"deep-get-set":11,"react":157}],11:[function(require,module,exports){
module.exports = deep;
              ...
              React.createElement("tbody", null, 
                React.createElement("tr", null, 
                    React.createElement("td", null, 
                        React.createElement("input", {id: "foodSelected", ref: "foodSelected", defaultValue: this.state.message, onFocus: this.inputHasFocus, 
                         className: "form-control-alt", placeholder: "Log A Meal"})
                    ), 
                    React.createElement("td", null, 
                        React.createElement("button", {className: "btn btn-primary btn-lg", onClick: this.foodLogged}, "Add")
                    )
                )
               )
            ), 
            React.createElement("h2", {className: "sub-header"}, " Logged Meals "), 
            React.createElement("input", {type: "text", ref: "searchFood", defaultValue: this.state.searchFood, className: "form-control", placeholder: "Search Food Name", onKeyUp: this.filterData}), 
              React.createElement(SimpleTable, {ref: "loggedMeals", className: "table table-striped", columns: [{columnHeader: 'Logged Meals', path: 'Logged_Meals'},
        ...
        return (
            ...
            React.createElement("table", {className: "table table-striped"}, 
              React.createElement("tbody", null, 
                React.createElement("tr", null, 
                    React.createElement("td", null, 
                        React.createElement(Instatype, {id: "food", ref: "food", requestHandler: this.typeAhead, selectedHandler: this.foodChosen, placeholder: "Log A Meal"})
                    ), 
                    React.createElement("td", null, 
                        React.createElement("button", {className: "btn btn-primary btn-lg", disabled: "true"}, "Add")
                    )
                )
               )
            ), 
...
React.render(React.createElement(Logger, null), 
    document.getElementById('react-container'));

},{"instatype":4,"moment":9,"react":157,"react-simple-table":10,"superagent":158}]},{},[161]);
